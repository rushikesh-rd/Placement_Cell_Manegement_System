			...
			<div class="owl-carousel owl-theme home-slider">
					...
					<div class="caption">
						<div class="container">
							<div class="col-md-6 col-sm-12">
								<h1>Choose a job you love, and you will never have to work
									a day in your life.</h1>
								<h3>—Confucius</h3>
								<a href="../tjsp/jobs.jsp" class="section-btn btn btn-default">Browse
									Jobs</a>
							</div>
						</div>
					</div>
				...
				<div class="item item-third">
					<div class="caption">
						<div class="container">
							<div class="col-md-6 col-sm-12">
								<h1>Failure doesn't mean you are a failure it just means you haven't succeeded yet.</h1>
